...
export const Header = () => {
  return (
    <header className="text-center py-6 md:py-12 relative md:pt-12 pt-32">
      ...
      {/* Subtitle */}
      <p className="text-lg md:text-xl text-gray-300 mt-4 md:mt-6 max-w-2xl mx-auto px-4 leading-relaxed">
        Transform complex jargon into simple, understandable language
        <span className="text-cyan-400 font-medium"> instantly</span>
      </p>
    </header>
  )
}
